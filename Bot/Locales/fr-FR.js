module.exports = {
	lang: 'fr',
	div : '<:izzysmine:921447883717373994> {{user}} **|** Vous cherchez un serveur Minecraft ? Venez rejoindre [IzzysMC](https://indevelopment.com)\n>> ⤷ **`IP:` **mc.izzysbot.xyz;\n⤷ **`Versions:`** Java (1.17.1/Original/Pirate).',
	afk: {
	...
	image: {
		...
		long: '✍️ %u **|** Votre message est trop long, essayez de le raccourcir à 300 caractères',
		achivment: 'Progrès réalisés !'
	},
	actions: {
		kiss: {
			description: '%u1 a embrassé %u2.',
			labels: {
				rt: 'Rembourser'
			}
		},
		slap: {
			description: '%u1 a perforé %u2.',
			labels: {
				rt: 'Rembourser'
			}
		},
		hug: {
			description: '%u1 a fait un câlin à %u2.',
			labels: {
				rt: 'Rembourser'
			}
		},
		pat: {
			description: '%u1 a tapoté %u2.',
			labels: {
				rt: 'Rembourser'
			}
		}
	...
	premium: 'Vous avez découvert une fonctionnalité premium, pour être un utilisateur premium, rejoignez mon [serveur de support](<https://discord.gg/Ny7anmsrjb>) !',
	bola: {
		title: '🎱 Boule Magique',
		field1: '**Question:**',
		field2: '**Réponse:**',
	...
	dashboard: 'La configuration du bot a été migrée vers le tableau de bord, accédez à ce lien : https://izzysbot.xyz/dashboard/%g',
	backup: {
		create: {
	...
	botban: {
		...
		description: '↳ Vous avez été interdit d\'utiliser `%z` par : `%r`\n> <:info:1213154090876538901> Vous pouvez faire appel sur notre [serveur d\'assistance](https://discord.gg/Ny7anmsrjb).'
	},
	...
	message: {
		...
		e3: 'Mon équipe est probablement déjà au courant de cette erreur, mais qu\'en est-il de votre aide ? Vous pouvez ouvrir un [issue](https://github.com/izzysbot/izzys/issues) dans [github](https://github. om/izzysbot/izzys) ou rapportez-le à mon [serveur de support](https://discord.gg/Ny7anmsrjb), faisons de la discord un meilleur endroit, ensemble 🤝',
		nsfw: 'Cette commande ne peut être utilisée que sur les salons nsfw'
	},
	host: {
		db: 'Nous avons utilisé [MongoDB](https://mongodb.com) pour meu banco de dados, hospedados em maquinas da   [Azure](https://azure.microsoft.com).',
		vps: 'Il est hébergé sur un VPS, utilise des machines de [OVH](https://ovh.com), avec le système opérationnel    Ubuntu.'
	},
	giveaway: {
		sec: 'secondes',
		min: 'minutes',
	...
	multiLang: {
		unknownLanguage: 'Langue inconnue.\n<:info:1213154090876538901> Langues disponibles : %langs',
	...
	slash: 'en raison de problèmes de compatibilité, j\'ai été complètement passé à **Commandes Slash**, si les commandes n\'apparaissent pas, ajoutez-moi en cliquant ici : [add](https://izzysbot.xyz/add), il n\'est pas nécessaire de supprimer le bot pour cela et si les commandes n\'ont pas encore été mises à jour sur votre serveur, il peut prendre jusqu\'à une heure pour les mettre à jour sur tous les serveurs, en raison de la discord.',
	avatar: {
		title: 'Avatar depuis:',
		download: 'Lien de téléchargement :',
		hex: 'Hex à utiliser dans votre profil :',
		click: 'Cliquez ici',
		footer : 'Si le plan ne fonctionne pas, changez le plan, pas l\'objectif'
	},
	perfil: {
		ngm: 'NON-BODY',
